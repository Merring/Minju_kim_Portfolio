$(document).ready(function () {
    ...
    */
    ...
    const works_list = [
        ...
        ["php_mychat.png", "[PHP / Mysql] PHP를 이용한 채팅 앱 웹사이트", "PHP와 Mysql을 이용하여 채팅 앱과 같은 느낌의 웹 사이트를 만드는 작업을 하였습니다! 회원끼리 채팅 메시지를 주고 받을 수 있으며, 전송된 메시지 삭제도 가능합니다.", "mindy000.dothome.co.kr/My chat"],
    ];
